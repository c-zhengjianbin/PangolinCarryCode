 ...
 */
public class PropertyDeal implements TemplateDirectiveModel {
    ...
    public   void  execute(Environment env,
        ...
        if  (body !=  null ) {
            ...
            body.render(new  PropertyDealWriter(env.getOut()));
        } else  {
     ...
     */
    private   static   class  PropertyDealWriter  extends  Writer {

        private   final  Writer out;

        PropertyDealWriter (Writer out) {
            this .out = out;
        }
